...
import { PAYMENT_MODES, WATER_SERVICE_TYPE_LABELS } from '@/constants';
...
export default function WaterSupplyPaymentsModal({
  ...
  const addPaymentMut = useMutation({
    mutationFn: (data: unknown) => waterSuppliesApi.addPayment(record.id, data),
    onSuccess: () => {
        ...
        >
          <div>
            ...
            <span className="badge badge-blue">
              {WATER_SERVICE_TYPE_LABELS[record.serviceType] || record.serviceType}
            </span>
          </div>
          <div>
