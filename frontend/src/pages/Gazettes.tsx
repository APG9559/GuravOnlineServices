            ...
            <button
              ...
              onClick={() =>
                reset({
                  ...
                  serviceFee: pricing.gazette_service_fee ?? 150,
                  amountCharged:
                    (pricing.gazette_official_fee ?? 500) + (pricing.gazette_service_fee ?? 150),
                })
              }
            >
              Clear
      ...
      {showShareModal && savedRecord && (
        <CustomerShareReceiptModal
          service={{
            ...
            description: `Gazette Name Change: ${savedRecord.oldName} ➔ ${savedRecord.newName}`,
