...
export default function ServiceFormsTab({
  ...
  const { data: searchedConnections = [], refetch: refetchConn } = useQuery({
  ...
  const { register, handleSubmit, control, watch, setValue, reset, formState: { errors } } = methods;
  ...
  useEffect(() => {
    const total = Number(officialFee) + Number(serviceFee) + Number(protocolFee) + Number(miscFee) - Number(discount);
  ...
  const saveMutation = useMutation({
    ...
    onError: (err: any) => {
      toast.error(err.response?.data?.message || err.message || 'Failed to save water supply record');
    },
  });
  ...
  return (
    <div style={{ maxWidth: 740, margin: '0 auto' }}>
      <form onSubmit={handleSubmit((d) => saveMutation.mutate(d))} style={{ display: 'flex', flexDirection: 'column', gap: '1.25rem' }}>
        ...
        {serviceType !== 'NewConnection' && (
          <div className="form-group" style={{ position: 'relative' }}>
            ...
            {selectedConnection && (
              <div style={{ marginTop: 10, background: 'var(--accent-light)', border: '2px solid var(--border)', borderRadius: 'var(--radius)', padding: '12px' }}>
                <div style={{ fontWeight: 700, fontSize: 13 }}>✓ Profile Linked: {selectedConnection.connectionNo || 'PENDING'}</div>
                <div style={{ fontSize: 12, marginTop: 4 }}>
                  Owner: <strong>{selectedConnection.currentOwner}</strong> | Address: {selectedConnection.connectionAddress}
                </div>
              </div>
            )}
          </div>
        ...
        {serviceType === 'NewConnection' && (
          <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
            <div style={{ fontSize: 14, fontWeight: 700, borderBottom: '2px solid var(--border)', paddingBottom: 6 }}>
            ...
            <div className="grid-2">
              ...
              <div className="form-group">
                ...
                {showAutoFillIndicator && (
                  <span className="success-text" style={{ fontSize: 11, display: 'block', marginTop: 4 }}>
            ...
            <div className="grid-2">
              ...
              <div className="form-group">
                ...
                <input
                  type="text"
                  {...register('meterDetails')}
                  placeholder="e.g. ME-19202"
                />
              </div>
            </div>

            <div style={{ fontSize: 14, fontWeight: 700, borderBottom: '2px solid var(--border)', paddingBottom: 6, marginTop: 8 }}>
              Plumber Information
            </div>
            <div className="grid-2">
              <div className="form-group">
            ...
            <div className="grid-2">
              <div className="form-group">
                ...
                <input
                  ...
                  style={isContactSameAsPlumber ? { background: 'var(--bg)', cursor: 'not-allowed' } : {}}
                />
              </div>
              <div className="form-group">
        ...
        <div style={{ border: '2.5px solid var(--border)', borderRadius: 'var(--radius)', background: 'var(--accent-light)', padding: 16, boxShadow: '3px 3px 0 var(--border)' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(130px, 1fr))', gap: 16 }}>
            <div className="form-group" style={{ marginBottom: 0 }}>
              ...
              <input
                ...
                style={!isManualOverrideAllowed ? { background: 'var(--bg)', cursor: 'not-allowed' } : {}}
              />
            </div>
            <div className="form-group" style={{ marginBottom: 0 }}>
            ...
            <div className="form-group" style={{ marginBottom: 0 }}>
              ...
              <input
                ...
                readOnly
                style={{ background: 'var(--bg)', cursor: 'not-allowed', fontWeight: 800, color: 'var(--primary)' }}
              />
            </div>
          </div>
        </div>
        ...
        <div style={{ display: 'flex', gap: 12, marginTop: 8 }}>
          <button
            ...
            disabled={saveMutation.isPending || (serviceType !== 'NewConnection' && !selectedConnection)}
            style={{ flex: 1 }}
          >
