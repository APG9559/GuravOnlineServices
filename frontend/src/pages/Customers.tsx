  ...
  return (
    <div>
      ...
      <div className={`customers-layout ${selectedCustomerId && !isMobile ? 'two-col' : 'one-col'}`}>
        ...
        {/* Customer Unified Service History View — Desktop: side panel, Mobile: modal */}
...
// ── Extracted History Panel (used for both desktop side-panel and mobile modal) ──
function CustomerHistoryPanel({
  ...
  return (
    <div className="card" style={{ display: 'flex', flexDirection: 'column', gap: '1.25rem', height: isMobileModal ? '100%' : 'fit-content', ...(isMobileModal ? { border: 'none', boxShadow: 'none', borderRadius: 0 } : {}) }}>
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start' }}>
        ...
        <div style={{ display: 'flex', gap: 6 }}>
          {customerDetails && (
            <button className="btn btn-sm" onClick={() => onEditClick(customerDetails)}>Edit Profile</button>
          )}
          <button className="btn btn-sm" style={{ minWidth: 32 }} onClick={onClose}>✕ Close</button>
        </div>
      </div>
      ...
      {detailsLoading ? (
        ...
        <>
          ...
          <div style={{ flex: 1, minHeight: 0 }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 12, maxHeight: isMobileModal ? 'none' : '420px', overflowY: 'auto', paddingRight: 4 }}>
              {customerDetails.services.map((s) => (
                ...
                >
                  ...
                  <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', fontSize: 12 }}>
                    ...
                    <button className="btn btn-sm" style={{ padding: '3px 8px', fontSize: 11 }} onClick={() => onPrintReceipt(s)}>
                      🖨 Print Receipt
                    </button>
                  </div>
                </div>
