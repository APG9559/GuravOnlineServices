...
export default function TicketDetailsModal({
  ...
  const addPaymentMut = useMutation({
    mutationFn: (data: Parameters<typeof marriagesApi.addPayment>[0]) => marriagesApi.addPayment(data),
    onSuccess: () => {
  ...
  useEffect(() => {
    ...
    ticket?.questionnaireData?.affidavitsPaidSeparately,
  ...
  const amountCharged =
    Number(ticket.amountCharged) - (affidavitsPaidSeparately ? estimatedAffidavitTotal : 0);
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <h3
            style={{ fontSize: 18, fontWeight: 700, marginBottom: '1.5rem', textAlign: 'center' }}
          >
          ...
          <div className="price-box" style={{ marginBottom: 20 }}>
            ...
            {estimatedAffidavitTotal > 0 && (
              ...
              >
                ...
                />
                <label
                  htmlFor="modal-affidavits-paid-separately"
                  style={{
                    margin: 0,
                    fontSize: 13,
                    fontWeight: 600,
                ...
                >
                  Affidavits executed & paid separately (excludes ₹{estimatedAffidavitTotal} from
                  this ticket)
                </label>
              </div>
            )}
                  ...
                  <table style={{ width: '100%', fontSize: '12px', borderCollapse: 'collapse' }}>
                    <thead>
                      ...
                      >
                        ...
                        {isAdmin && (
                          <th style={{ padding: '6px 8px', textAlign: 'center' }}>Act</th>
                        )}
                      </tr>
                    </thead>
                    <tbody>
                  ...
                  {!showAddForm ? (
                    ...
                    >
                      ...
                      <div style={{ display: 'flex', flexDirection: 'column', gap: '14px' }}>
                        ...
                        {error && (
                          <div
                            style={{ color: 'var(--danger)', fontSize: '11px', fontWeight: 500 }}
                          >
                            ⚠️ {error}
                          </div>
                        )}
          ...
          <div
            style={{ display: 'flex', justifyContent: 'flex-end', gap: '8px', marginTop: '1rem' }}
          >
            {ticket.status === 'Confirmed' &&
              onProceed &&
              (() => {
                    ...
                    onClick={() => {
                      if (!isFullyPaid) {
                        if (onShowAlert) {
                          onShowAlert(
                            ...
                            <span>
                              ...
                              <strong style={{ fontWeight: 700 }}>
                                <u> ₹{balance.toLocaleString('en-IN')} </u>
                              </strong>
                              .
                              <br />
                              <br />
                          ...
                          alert(
                            `Cannot complete ticket. There is a remaining balance of ₹${balance.toLocaleString('en-IN')}.\n\nPlease record the remaining payment first.`,
                          );
                        }
                        return;
                      }
