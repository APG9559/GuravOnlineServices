...
export default function MarriagesPage() {
  ...
  const [prefillMode, setPrefillMode] = useState<'save_ticket' | 'complete_record'>(
    'complete_record',
  );
      ...
      {showTicketSavedModal && savedTicket && (
        ...
        >
          ...
          >
            ...
            <p style={{ fontSize: 14, color: 'var(--text-muted)', marginBottom: '1.5rem' }}>
              Ticket state for {savedTicket.contactName} ({savedTicket.ticketNumber}) has been
